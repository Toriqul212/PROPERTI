        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="row">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="input-group">
                                <div class="form-outline">
                                    <form method="get" action="data-rumah.php">
                                        <input type="text" placeholder="Search Kode Rumah...." name="cari" autocomplete="off" class="form-control" />
                    ...
                    <strong>Berhasil!!! </strong> Meng-Update Data Rumah
                    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                      <span aria-hidden='true'>&times;</span>
                            ...
                            <table class="table table-striped">
                                ...
                                <?php
                                $sql = "SELECT * FROM t_rumah WHERE kd_rumah LIKE '%" . $cari . "%'";

...
$sql = "SELECT * FROM t_akun WHERE id_akun=$id_akun";
                    ...
                    <div class="container" style="background-color: white;"><br>
                        ...
                        <div class="row">
                            <div class="container" style="background-color: white;">
                                ...
                                <br>
                                <br>
                                <p><b>SETTING AKUN</b></p>
                                <form method="post" action="proses-akun.php">
                                    <table class="table">
                                        <input type="hidden" name="id" value="<?php echo $siswa['id_akun'] ?>" />

                                        <tr>
                                            <td>USERNAME</td>
                                            <td><input type="text" class="form-control" readonly value="<?php echo $siswa['username'] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>PASSWORD</td>
                                            <td><input type="password" class="form-control" name="password" id="myInput" value="<?php echo $siswa['password'] ?>">

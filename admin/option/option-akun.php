            ...
            <li class="nav-item active">
                ...
                <div id="collapseOne" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="option-akun.php">Option Akun</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="row">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="input-group">
                                <div class="form-outline">
                                    <form method="get" action="data-tefa.php">
                                        <input type="text" placeholder="Search...." name="cari" autocomplete="off" class="form-control" />
                    ...
                    <strong>Berhasil!!! </strong> Merubah Data Akun
                    ...
                    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                      <span aria-hidden='true'>&times;</span>
                            ...
                            <table class="table table-striped">
                                ...
                                <?php
                                $sql = "SELECT * FROM t_akun WHERE username LIKE '%" . $cari . "%'";
                                $query = mysqli_query($db, $sql);
                                while ($siswa = mysqli_fetch_array($query)) { ?>
                                    <tr>
                                        <td align="center"><?php echo $siswa['username'] ?></td>
                                        <td align="center"><?php echo $siswa['password'] ?></td>
                                        <td align="center"><a class="btn btn-dark" href="edit-akun.php?id=<?php echo $siswa['id_akun'] ?>" role="button">Edit</a>
                                            <a class="btn btn-dark" onclick="return confirm('Apakah Anda Yakin ?')" style="text-decoration: none;" href="hapus-akun.php.?id=<?php echo $siswa['id_akun'] ?>">Hapus</a>
                                        </td>

        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="row">
                    ...
                    <strong>Berhasil!!! </strong> Menambahkan Data Rumah
                    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                      <span aria-hidden='true'>&times;</span>
                            ...
                            <table class="table table-striped">
                                ...
                                <?php
                                $sql = "SELECT * FROM t_rumah WHERE jenis_rumah LIKE '%" . $cari . "%'";
                                ...
                                while ($siswa = mysqli_fetch_array($query)) { ?>
                                    <tr>
                                        ...
                                        <td align="center"><a class="btn btn-success" href="edit-datarumah.php?id=<?php echo $siswa['kd_rumah'] ?>" role="button">Update Data</a>

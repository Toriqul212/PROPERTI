                        ...
                        <div class="container-fluid">
                            ...
                            <div class="input-group">
                                <div class="form-outline">
                                    <form method="get" action="data-pembayaran.php">
                                        <input type="text" placeholder="Search NIK...." name="cari" autocomplete="off" class="form-control" />
                    ...
                    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                      <span aria-hidden='true'>&times;</span>
                            ...
                            <table class="table table-striped">
                                ...
                                FROM t_pemesanan 
                                JOIN t_pembayaran 
                                ON t_pemesanan.kd_pembayaran =t_pembayaran.kd_pembayaran WHERE nik LIKE '%" . $cari . "%'";
                                $query = mysqli_query($db, $sql);
                                while ($siswa = mysqli_fetch_array($query)) { ?>
                                    <tr>
                                        <td align="center"><?php echo $siswa['kd_pemesanan'] ?></td>
                                        <td align="center"><?php echo $siswa['kd_pembayaran'] ?></td>
                                        <td align="center"><?php echo $siswa['kd_marketing'] ?></td>
                                        <td align="center"><?php echo $siswa['nik'] ?></td>
                                        <td align="center"><?php echo $siswa['kd_rumah'] ?></td>
                                        <td align="center"><?php echo $siswa['tanggal_waktu'] ?></td>
                                        <td align="center"><?php echo $siswa['status'] ?></td>

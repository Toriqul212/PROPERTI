                ...
                <div class="row">
                    <div class="container" style="background-color: white;"><br>
                        ...
                        <div class="alert alert-secondary" align="center" role="alert">
                            <b style="color:black;">KONFIRMASI PEMBELIAN RUMAH</b>
                        </div>

                        <?php
                        if (isset($_POST['daftar'])) {
                            echo '<table class=table>';
                            echo '<tr><td>' . 'Kode Pemesanan ' . '</td><td>' . $_POST['kd_pemesanan'] . '</td></tr>';
                            echo '<tr><td>' . 'Kode Pembayaran ' . '</td><td>' . $_POST['kd_pembayaran'] . '</td></tr>';
                            echo '<tr><td>' . 'Nama Lengkap ' . '</td><td>' . $_POST['nama_lengkap'] . '</td></tr>';
                            echo '<tr><td>' . 'NIK ' . '</td><td>' . $_POST['nik'] . '</td></tr>';
                            echo '<tr><td>' . 'Kode Rumah ' . '</td><td>' . $_POST['kd_rumah'] . '</td></tr>';
                            echo '</table>';
                        } ?>
                        <button class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal2">
                            <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a class="btn btn-secondary" href="beli-rumah.php">Cancel</a>
                                        <a class="btn btn-primary" href="../index.php">Beli</a>
                                    </div>
                                </div>
                            </div>
                        </div>
